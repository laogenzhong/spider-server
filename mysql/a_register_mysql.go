...
func InitWithConfig(mysqlCfg appconfig.MySQLConfig) {
	...
	models := []any{
		...
		&mysqlmodel2.FriendPlanShareRecord{},
		&mysqlmodel2.FriendSharedContentScoreRecord{},
		&mysqlmodel2.FriendSharedContentUseEventRecord{},
		...
		&mysqlmodel2.PaywallSessionRecord{},
		&mysqlmodel2.AppUpdateConfig{},
		&mysqlmodel2.ClientSyncFailure{},
	}
